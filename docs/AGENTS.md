...
- `docs/process/python-packaging.md`：Python package 分发物的引入边界、版本来源与发布渠道规则
...
- 当前主干 live 最小套件：`spec.md`、`plan.md`
- legacy `TODO.md` 已退出 formal governance flow；不得新增、回写或继续承担状态镜像 / 恢复主入口职责
