...
- `FR-0008` 的本地持久化与共享序列化管线已由 PR `#148` 合入主干。
- 当前 active closeout 入口包括：
  - `docs/exec-plans/CHORE-0125-fr-0008-parent-closeout.md`：收口 `#127/#140` 与 `FR-0008` 已合入主干事实
  - `docs/exec-plans/CHORE-0126-fr-0009-formal-spec-closeout.md`：收口 `#141` 的 formal spec 套件与 `FR-0009` requirement container
