...
- release 文档必须遵守 [版本管理规则](../process/version-management.md)，区分 roadmap milestone、release index、Git tag、GitHub Release 与 runtime schema version。
...
- 不把上层应用完整度、provider 产品支持或局部 schema version 写成 release 完成条件。
