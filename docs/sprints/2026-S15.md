...
- `FR-0004-input-target-and-collection-policy`：`v0.2.0` 共享输入模型与采集策略 formal spec；当前父事项 closeout 继续由 FR `#64` 承接
...
- `FR-0004` 的 implementation 子事项 `#87/#89/#88` 已全部合入主干，对应 PR `#90/#91/#92`；`#68` 聚合 closeout 已由 PR `#93` 收口，当前仅剩 `#64` 父 FR closeout。
...
- `FR-0004` 当前进入父事项 closeout 回合，由 `docs/exec-plans/FR-0004-input-target-and-collection-policy.md` 承接 `#64` 的最终收口。
...
- 相关 Issue / PR：`#38`、`#39`、`#40`、`#41`、`#42`、`#44`、`#47`、`#48`、`#50`、`#51`、`#52`、`#64`、`#65`、`#66`、`#67`、`#69`、`#70`、`#74`、`#77`、`#79`、`#84`、`#87`、`#88`、`#89`、`#90`、`#91`、`#92`、`#93`
...
- exec-plan：
  ...
  - `docs/exec-plans/FR-0004-input-target-and-collection-policy.md`（current active；绑定 Issue `#64`）
