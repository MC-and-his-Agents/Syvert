...
- decision：`docs/decisions/ADR-0003-github-delivery-structure-and-repo-semantic-split.md`（上位 shared decision；`TODO.md` 退出语义已由 `docs/decisions/ADR-GOV-0029-remove-legacy-todo-md.md` 取代）
