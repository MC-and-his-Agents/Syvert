...
- `CHORE-0100-fr-0006-parent-closeout`：`FR-0006` 父事项 closeout Work Item，对应 Issue `#110`，当前受审 PR `#111`
...
- `CHORE-0100` 当前由 PR `#111` 承接 `FR-0006` 父事项 closeout，负责把 `#66` 与 formal spec / implementation / release / sprint / exec-plan 收成一致。
