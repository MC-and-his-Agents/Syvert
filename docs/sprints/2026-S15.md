...
- `FR-0004-input-target-and-collection-policy`：`v0.2.0` 共享输入模型与采集策略 formal spec；该 requirement 绑定 FR `#64`，formal spec 已由 PR `#82` 合入，此处仅保留索引语义
- `CHORE-0068-fr-0004-implementation-closeout`：`FR-0004` 当前 active implementation 聚合 closeout，对应 Issue `#68`
...
- `FR-0004` 的 implementation 子事项 `#87/#89/#88` 已全部合入主干，对应 PR `#90/#91/#92`；当前仅剩 `#68` 聚合 closeout 与 `#64` 父 FR closeout。
...
- `CHORE-0068` 负责当前 sprint 中 `FR-0004` 的 implementation 聚合 closeout，归档 `#87/#89/#88` 与对应 PR `#90/#91/#92` 的主干实现链。
...
- exec-plan：
  ...
  - `docs/exec-plans/CHORE-0068-fr-0004-implementation-closeout.md`（current active；绑定 Issue `#68` / PR `#93`）
