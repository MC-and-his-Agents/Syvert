...
- `GOV-0345-v0-8-0-phase-release-closeout-record`：补齐 `v0.8.0` final Phase / release closeout artifact 与 published truth 锚点，对应 Issue `#345`
...
- Phase `#293`、父 FR `#294/#295/#296/#297/#298`、parent closeout Work Item `#303/#316/#312/#322/#327` 均已关闭为 `closed completed`；对应 parent closeout PR `#308/#336/#344/#343/#342` 已合入主干。
...
- `#345 / GOV-0345` 阶段 B 回写本 published truth carrier；本事项不新增 runtime、formal spec、Adapter 或 Provider 语义。
