...
- `#345 / GOV-0345` 阶段 A 只补齐上述 closeout carrier；阶段 A 合入后创建 `v0.8.0` tag / GitHub Release，阶段 B 回写 published truth、发布锚点与阶段 A merge commit；本事项不新增 runtime、formal spec、Adapter 或 Provider 语义。
