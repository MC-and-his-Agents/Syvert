...
- `GOV-0029` 分两步执行：先以独立 formal spec / governance contract PR 更新 `FR-0003` formal spec、当前事项工件，以及 `WORKFLOW.md`、`docs/AGENTS.md`、`spec_review.md`、`docs/specs/README.md`、`docs/process/agent-loop.md`、`docs/specs/_template/**` 的权威口径；再以独立 `governance` 类 PR 落地 guard、policy、`open_pr`、回归测试与存量 legacy `TODO.md` 清理。
