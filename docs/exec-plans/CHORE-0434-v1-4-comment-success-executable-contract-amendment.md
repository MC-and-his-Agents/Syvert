...
- `python3 scripts/governance_gate.py --mode ci --base-sha 918cff01a8fa3b8488cfee747d79f07233c84691 --head-sha HEAD --head-ref issue-434-404-v1-4-0-comment-success-executable-contract-amendment`
...
- #432 must merge after this Work Item to make the formal spec truth explicit.
