...
- 当前工作树正在根据 guardian 审查补齐两处 authoritative 残留：将 FR-0003 明确扩展到关闭 legacy `TODO.md` 所需的 guard / policy / regression 调整，并把 FR-0001 中仍允许维护 `TODO.md` 的正式规约文本改为 legacy-only。
