...
- 当前 formal spec closeout 由 `docs/exec-plans/CHORE-0138-fr-0013-formal-spec-closeout.md` 承担；formal spec 收口、review-sync 与后续 PR 元数据必须统一回写到该 Work Item，而不是在 requirement container 中混入执行态细节。
