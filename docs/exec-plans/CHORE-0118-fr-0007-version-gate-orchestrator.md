...
- `97f08629de35a7576f5e5e4d16605bc1f1ffab58`
- 说明：该 checkpoint 已覆盖 guardian 三轮前的全部代码修复；当前 follow-up 仅用于把 active exec-plan 与最新代码 checkpoint、PR `#122` 及审查证据对齐，不再改动运行时代码。
