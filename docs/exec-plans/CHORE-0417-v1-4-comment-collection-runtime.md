...
- `python3 -m unittest tests.runtime.test_models tests.runtime.test_comment_collection tests.runtime.test_read_side_collection tests.runtime.test_operation_taxonomy tests.runtime.test_operation_taxonomy_admission_evidence tests.runtime.test_runtime tests.runtime.test_task_record tests.runtime.test_registry tests.runtime.test_resource_capability_evidence tests.runtime.test_platform_leakage tests.runtime.test_real_adapter_regression tests.runtime.test_cli_http_same_path tests.runtime.test_version_gate tests.runtime.test_third_party_adapter_contract_entry`（507 tests）
- `python3 -m unittest tests.runtime.test_runtime.RuntimeExecutionTests.test_execute_task_rejects_reply_drift_after_adapter_mutates_visible_cursor tests.runtime.test_runtime.RuntimeExecutionTests.test_execute_task_passes_comment_request_cursor_to_adapter_context tests.runtime.test_runtime.RuntimeExecutionTests.test_contract_harness_uses_comment_request_cursor_context tests.runtime.test_third_party_adapter_contract_entry.ThirdPartyAdapterContractEntryTests.test_fixture_request_cursor_is_passed_to_adapter_request`
- `python3 -m unittest tests.runtime.test_models tests.runtime.test_comment_collection tests.runtime.test_read_side_collection tests.runtime.test_operation_taxonomy tests.runtime.test_operation_taxonomy_admission_evidence tests.runtime.test_runtime tests.runtime.test_task_record tests.runtime.test_registry tests.runtime.test_resource_capability_evidence tests.runtime.test_platform_leakage tests.runtime.test_real_adapter_regression tests.runtime.test_cli_http_same_path tests.runtime.test_version_gate tests.runtime.test_third_party_adapter_contract_entry`（508 tests）
- `python3 -m unittest tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_opaque_independent_target_linkage tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_opaque_parent_linkage_without_root_target tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_nested_reply_window_binds_continuation_to_parent_comment tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_accepts_nested_reply_window_bound_to_parent tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_accepts_descendant_reply_window`
- `python3 -m unittest tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_independent_target_linkage_for_direct_reply tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_opaque_parent_linkage_without_root_target tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_parent_drift_with_root_target tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_nested_reply_window_binds_continuation_to_parent_comment tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_accepts_nested_reply_window_bound_to_parent tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_accepts_descendant_reply_window`
- `python3 -m unittest tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_window_allows_descendant_reply_within_resumed_thread`
- `python3 -m unittest tests.runtime.test_models tests.runtime.test_comment_collection tests.runtime.test_read_side_collection tests.runtime.test_operation_taxonomy tests.runtime.test_operation_taxonomy_admission_evidence tests.runtime.test_runtime tests.runtime.test_task_record tests.runtime.test_registry tests.runtime.test_resource_capability_evidence tests.runtime.test_platform_leakage tests.runtime.test_real_adapter_regression tests.runtime.test_cli_http_same_path tests.runtime.test_version_gate tests.runtime.test_third_party_adapter_contract_entry`（509 tests）
- `python3 -m unittest tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_independent_target_linkage_for_direct_reply tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_nested_reply_window_binds_continuation_to_parent_comment tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_rejects_target_ref_as_thread_proof tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_accepts_nested_reply_window_bound_to_parent`
- `python3 -m unittest tests.runtime.test_models tests.runtime.test_comment_collection tests.runtime.test_read_side_collection tests.runtime.test_operation_taxonomy tests.runtime.test_operation_taxonomy_admission_evidence tests.runtime.test_runtime tests.runtime.test_task_record tests.runtime.test_registry tests.runtime.test_resource_capability_evidence tests.runtime.test_platform_leakage tests.runtime.test_real_adapter_regression tests.runtime.test_cli_http_same_path tests.runtime.test_version_gate tests.runtime.test_third_party_adapter_contract_entry`（510 tests）
- `python3 -m unittest tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_independent_target_linkage_for_direct_reply tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_window_allows_descendant_reply_when_target_matches_non_root_resume tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_accepts_non_root_descendant_when_target_matches_resume tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_rejects_target_ref_as_thread_proof`
- `python3 -m unittest tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_only_top_level_page_allows_top_level_next_continuation tests.runtime.test_runtime.RuntimeExecutionTests.test_execute_task_normalizes_dataclass_cursor_before_adapter_context`
- `python3 -m unittest tests.runtime.test_models tests.runtime.test_comment_collection tests.runtime.test_read_side_collection tests.runtime.test_operation_taxonomy tests.runtime.test_operation_taxonomy_admission_evidence tests.runtime.test_runtime tests.runtime.test_task_record tests.runtime.test_registry tests.runtime.test_resource_capability_evidence tests.runtime.test_platform_leakage tests.runtime.test_real_adapter_regression tests.runtime.test_cli_http_same_path tests.runtime.test_version_gate tests.runtime.test_third_party_adapter_contract_entry`（512 tests）
...
- `python3 -m unittest tests.runtime.test_models tests.runtime.test_comment_collection tests.runtime.test_read_side_collection tests.runtime.test_operation_taxonomy tests.runtime.test_operation_taxonomy_admission_evidence tests.runtime.test_runtime tests.runtime.test_task_record tests.runtime.test_registry tests.runtime.test_resource_capability_evidence tests.runtime.test_platform_leakage tests.runtime.test_real_adapter_regression tests.runtime.test_cli_http_same_path tests.runtime.test_version_gate tests.runtime.test_third_party_adapter_contract_entry`（513 tests）
- `python3 -m unittest tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_rejects_target_ref_as_thread_proof tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_window_allows_descendant_reply_when_target_matches_non_root_resume tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_accepts_non_root_descendant_when_target_matches_resume tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_direct_reply_target_self_reference tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_nested_reply_target_self_reference tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_rejects_reply_target_self_reference`
- `python3 -m unittest tests.runtime.test_models tests.runtime.test_comment_collection tests.runtime.test_read_side_collection tests.runtime.test_operation_taxonomy tests.runtime.test_operation_taxonomy_admission_evidence tests.runtime.test_runtime tests.runtime.test_task_record tests.runtime.test_registry tests.runtime.test_resource_capability_evidence tests.runtime.test_platform_leakage tests.runtime.test_real_adapter_regression tests.runtime.test_cli_http_same_path tests.runtime.test_version_gate tests.runtime.test_third_party_adapter_contract_entry`（516 tests）
- `python3 -m unittest tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_request_cursor_rejects_malformed_dataclass_reply_cursor tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_request_cursor_rejects_dataclass_with_mapping_reply_cursor tests.runtime.test_runtime.RuntimeExecutionTests.test_execute_task_returns_comment_fail_closed_carrier_for_malformed_request_cursor tests.runtime.test_runtime.RuntimeExecutionTests.test_execute_task_returns_comment_fail_closed_carrier_for_malformed_dataclass_cursor tests.runtime.test_runtime.RuntimeExecutionTests.test_execute_task_returns_comment_fail_closed_carrier_for_dataclass_cursor_with_mapping_child tests.runtime.test_comment_collection.CommentCollectionCarrierTests.test_reply_hierarchy_rejects_independent_target_linkage_for_direct_reply tests.runtime.test_runtime.RuntimeExecutionTests.test_validate_success_payload_rejects_target_ref_as_thread_proof`
- `python3 -m unittest tests.runtime.test_models tests.runtime.test_comment_collection tests.runtime.test_read_side_collection tests.runtime.test_operation_taxonomy tests.runtime.test_operation_taxonomy_admission_evidence tests.runtime.test_runtime tests.runtime.test_task_record tests.runtime.test_registry tests.runtime.test_resource_capability_evidence tests.runtime.test_platform_leakage tests.runtime.test_real_adapter_regression tests.runtime.test_cli_http_same_path tests.runtime.test_version_gate tests.runtime.test_third_party_adapter_contract_entry`（516 tests）
...
- PR `#429` guardian finding：shared contract harness 仍把所有 success payload 当成 `content_detail_by_url`。
  - 处理：已让 shared validation helper 从 collection target 推导 target context，并对 collection/comment collection success envelope 保留 carrier 字段；公开 third-party entry 仍保持 content-detail profile，comment_collection public entry 留给 #418 consumer/contract migration。
...
- PR `#429` guardian finding：contract harness 使用 payload 自身 target context 会漏掉 collection/comment target drift。
  - 处理：已让 `ContractSampleDefinition` 携带 expected target context，validation helper 使用 expected target 校验 payload；公开 third-party entry 仍保持 content-detail profile，comment_collection public entry 留给 #418。
...
- PR `#429` guardian finding：malformed request cursor 仍漏出通用 failed envelope。
  - 处理：已把 malformed request cursor 收敛为 `comment_collection` fail-closed carrier，且请求结构错误固定归类为 `signature_or_request_invalid`；well-formed 但跨 target/thread 的 cursor 仍归类为 `cursor_invalid_or_expired`。
...
- PR `#429` guardian finding：malformed dataclass cursor 的错误嵌套类型会抛异常而不是 fail-closed，且 comment carrier 接受 `complete + partial_result`。
  - 处理：已将 dataclass cursor 序列化异常收敛为 `signature_or_request_invalid`，并禁止 emitted `error_classification=partial_result`；partial page 固定使用 `result_status=partial_result + error_classification=parse_failed`。
...
- PR `#429` guardian finding：third-party contract entry success observation 仍按 content-detail raw/normalized 校验 collection/comment carrier。
  - 处理：已让 success envelope builder / validation helper 优先按 collection/comment carrier 的 `target.target_ref` 校验 target 绑定；公开 third-party entry 仍按 content-detail profile 准入。
- PR `#429` guardian finding：adapter 可通过修改可变 `request_cursor` 绕过 reply-thread drift 校验。
  - 处理：runtime 现在在 adapter 执行前分别 deep-copy adapter 可见 cursor 与 validation cursor snapshot，成功态校验只使用 validation snapshot；validation helper 同样隔离 sample/build validation cursor，并补 adapter cursor mutation regression。
- PR `#429` guardian finding：reply item 的 parent/target linkage 仍可接受无法证明同线程的 opaque drift。
  - 处理：已收紧 reply item 结构校验，不解析 opaque 编码，但要求 `parent_comment_ref == root_comment_ref` 或 `target_comment_ref == root_comment_ref` 作为同线程显式证明；`target_comment_ref` 只能绑定 root 或 parent，并改写原先放行 opaque drift 的测试为拒绝回归。
- PR `#429` guardian finding：reply hierarchy 仍接受 `target_comment_ref == root_comment_ref` 为任意 parent 背书，同时错误禁止独立 target linkage。
  - 处理：已改为 direct reply `parent_comment_ref == root_comment_ref` 合法；nested reply 必须保留独立 `target_comment_ref`，不能用 root/parent 自身冒充证明；独立 target linkage 重新允许，并补 parent drift with root target regression。
- PR `#429` guardian finding：`target_comment_ref` 可为另一线程背书，绕过 reply-window 绑定。
  - 处理：runtime/thread continuation 绑定只接受 `target_comment_ref == resume_comment_ref` 这类显式绑定；direct reply 的独立 target drift 会在 carrier 层 fail-closed，nested reply 仍可保留独立 target linkage。
...
- PR `#429` guardian finding：direct reply 独立 `target_comment_ref` 被误拒，且 nested reply 可通过伪造 `target_comment_ref` 绕过 thread 绑定。
  - 处理：已恢复 direct reply 独立 target linkage；runtime/continuation thread proof 只接受等于请求 `resume_comment_ref` 的 `target_comment_ref` 命中，root/parent/target 都不属于恢复线程时必须 fail-closed。
...
- PR `#429` guardian finding：合法非 root reply-window 后代会被误判为 drift，且 reply item 未禁止 `target_comment_ref` 自引用。
  - 处理：已允许 `target_comment_ref == resume_comment_ref` 作为非 root reply-window 后代的显式绑定证明；同时禁止 reply item 的 `target_comment_ref == canonical_ref`，补 direct/nested self-reference 与 runtime/carrier regressions。
- PR `#429` guardian finding：malformed request cursor 被误分类为 `parse_failed`，且 direct reply 仍接受跨线程 `target_comment_ref`。
  - 处理：已将 malformed request cursor 结构错误统一映射为 `signature_or_request_invalid`；direct reply 若提供 `target_comment_ref`，必须等于 root comment ref，不再接受任意跨线程 target。
