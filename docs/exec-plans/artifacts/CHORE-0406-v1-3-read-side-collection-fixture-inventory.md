...
| `platform_failed_collection` | `content_search_by_keyword` | `synthetic` | upstream provider/platform/network failure response | result classification is `platform_failed` or `provider_or_network_blocked` | `missing` |
