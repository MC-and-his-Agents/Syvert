...
- 当前 formal spec closeout 由 `docs/exec-plans/CHORE-0130-fr-0010-formal-spec-closeout.md` 记录 `#164` 的执行轮次。
...
- 当前分支已形成首个 formal spec 语义 checkpoint `4f5aed4b8540c2d627c01418a97c06b95b857727`，其后若仅追加 exec-plan / PR metadata，只作为 review-sync follow-up，不改写 requirement 语义。
