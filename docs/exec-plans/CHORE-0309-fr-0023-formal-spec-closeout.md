...
- `python3 scripts/pr_scope_guard.py --class spec --base-ref origin/main --head-ref HEAD`
  ...
  - 最新提交 `9abe813` 上复跑通过，PR class 为 `spec`，变更类别为 `docs, spec`。
...
- formal spec 语义 checkpoint：`876ff6c`
- exec-plan metadata 修正 checkpoint：`1a74b9dcb1fc389fe952637d330836872c9f5b27`
- validation follow-up checkpoint：`9abe813ab886a3c551d338494b8f346e2ab07934`
