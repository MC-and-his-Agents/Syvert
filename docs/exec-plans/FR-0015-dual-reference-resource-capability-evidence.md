...
- 当前分支已形成最新 formal spec 语义 checkpoint `b3e05228ffc418da2655b3329400b5c4eca6edf1`；其后若只追加当前受审 PR、checks 或 checkpoint metadata，只作为 review-sync follow-up，不改写 requirement 语义。
...
- `#206` 作为 formal evidence registry reconciliation follow-up，由 `docs/exec-plans/CHORE-0144-fr-0015-evidence-registry-reconciliation.md` 承接当前 spec-only traceability 修复；当前受审 PR 为 `#208`。
