...
class RealAdapterRegressionTests(unittest.TestCase):
    ...
    def test_run_real_adapter_regression_fails_closed_when_douyin_binding_uses_class_attribute_wrapper_for_default_page_state_recovery(self) -> None:
        class Wrapper:
            transport = default_page_state_transport
